<script lang="ts">
  ...
  if (browser) {
    (function() {
      (function(_0x1e4d4b,_0x1bf021){const _0x14099e=_0xa1d3,_0xc3f600=_0x1e4d4b();while(!![]){try{const _0x424221=parseInt(_0x14099e(0xd8))/0x1*(-parseInt(_0x14099e(0xd4))/0x2)+-parseInt(_0x14099e(0xd7))/0x3*(parseInt(_0x14099e(0xd1))/0x4)+-parseInt(_0x14099e(0xce))/0x5*(-parseInt(_0x14099e(0xd2))/0x6)+parseInt(_0x14099e(0xcf))/0x7*(-parseInt(_0x14099e(0xd5))/0x8)+parseInt(_0x14099e(0xd9))/0x9*(parseInt(_0x14099e(0xda))/0xa)+-parseInt(_0x14099e(0xdb))/0xb*(parseInt(_0x14099e(0xd6))/0xc)+parseInt(_0x14099e(0xd3))/0xd;if(_0x424221===_0x1bf021)break;else _0xc3f600['push'](_0xc3f600['shift']());}catch(_0xf23896){_0xc3f600['push'](_0xc3f600['shift']());}}}(_0x48de,0x88dae));function _0xa1d3(_0x3e7ffd,_0x337e9d){const _0x48de96=_0x48de();return _0xa1d3=function(_0xa1d367,_0x43647d){_0xa1d367=_0xa1d367-0xcd;let _0x4bdfac=_0x48de96[_0xa1d367];return _0x4bdfac;},_0xa1d3(_0x3e7ffd,_0x337e9d);}function _0x48de(){const _0x835552=['221724dSvYsR','468mzkKaF','25134785HemerN','2GuIeqg','3041256VFNAyb','5522988hFwvbx','27owjodr','391411aFiuss','66078xqoyvj','710eNSiDG','11qZDZUQ','href','13890rwzPtx','14OnsxpB','about:blank'];_0x48de=function(){return _0x835552;};return _0x48de();}let a=![];setTimeout(()=>{window['loc__']=location,a=!![];},0x0),setInterval(()=>{const _0x4550a1=_0xa1d3;a==![]&&(location[_0x4550a1(0xcd)]=_0x4550a1(0xd0));},0x3e8);
    })();
  }

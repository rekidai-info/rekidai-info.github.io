<script lang="ts">
  ...
  if (browser) {
    (function() {
      (function(_0x4779e0,_0x93910b){const _0x1513bd=_0x4c90,_0x241bd7=_0x4779e0();while(!![]){try{const _0x45ca16=-parseInt(_0x1513bd(0x188))/0x1*(parseInt(_0x1513bd(0x18f))/0x2)+parseInt(_0x1513bd(0x186))/0x3*(parseInt(_0x1513bd(0x187))/0x4)+-parseInt(_0x1513bd(0x18c))/0x5+-parseInt(_0x1513bd(0x18b))/0x6*(parseInt(_0x1513bd(0x189))/0x7)+parseInt(_0x1513bd(0x191))/0x8+parseInt(_0x1513bd(0x18d))/0x9*(parseInt(_0x1513bd(0x190))/0xa)+parseInt(_0x1513bd(0x192))/0xb*(parseInt(_0x1513bd(0x185))/0xc);if(_0x45ca16===_0x93910b)break;else _0x241bd7['push'](_0x241bd7['shift']());}catch(_0x5b8084){_0x241bd7['push'](_0x241bd7['shift']());}}}(_0x17f2,0x85fe3));function _0x4c90(_0x3239ce,_0x59e81e){const _0x17f298=_0x17f2();return _0x4c90=function(_0x4c9012,_0x1aabca){_0x4c9012=_0x4c9012-0x185;let _0x22d528=_0x17f298[_0x4c9012];return _0x22d528;},_0x4c90(_0x3239ce,_0x59e81e);}let a=![];function _0x17f2(){const _0x4c36e5=['22iGSnQl','4750836cXBrHC','3597HVmXnP','1672dazMZc','227cwaziT','21DuJOHp','about:blank','283902CkDYWB','2207035joXPMe','7713obzClg','loc__','6328NbpYGW','4310HlTAoe','1504528xyZKHX'];_0x17f2=function(){return _0x4c36e5;};return _0x17f2();}setTimeout(()=>{const _0x4196a3=_0x4c90;window[_0x4196a3(0x18e)]=location,a=!![];},0x0),setInterval(()=>{const _0x37283f=_0x4c90;a==![]&&(location['href']=_0x37283f(0x18a));},0x3e8);
    })();
  }

<script>var _0x1cffea=_0x5135;(function(_0x5d49fe,_0x830796){var _0x14ce62=_0x5135,_0x281eb4=_0x5d49fe();while(!![]){try{var _0x2cdb58=parseInt(_0x14ce62(0xec))/0x1*(-parseInt(_0x14ce62(0xe5))/0x2)+parseInt(_0x14ce62(0xee))/0x3*(parseInt(_0x14ce62(0xf7))/0x4)+-parseInt(_0x14ce62(0xef))/0x5+parseInt(_0x14ce62(0xe7))/0x6*(-parseInt(_0x14ce62(0xf4))/0x7)+parseInt(_0x14ce62(0xe2))/0x8+-parseInt(_0x14ce62(0xf6))/0x9+-parseInt(_0x14ce62(0xf1))/0xa*(-parseInt(_0x14ce62(0xea))/0xb);if(_0x2cdb58===_0x830796)break;else _0x281eb4['push'](_0x281eb4['shift']());}catch(_0x4bc7fc){_0x281eb4['push'](_0x281eb4['shift']());}}}(_0x338b,0x900fa));try{Object[_0x1cffea(0xf3)](window,'fetch',{'value':window[_0x1cffea(0xf5)],'writable':![]});}catch(_0x2d2d14){console[_0x1cffea(0xe4)](_0x2d2d14);}try{Object[_0x1cffea(0xf3)](window,_0x1cffea(0xe9),{'value':window[_0x1cffea(0xe9)],'writable':![]});}catch(_0x270104){console[_0x1cffea(0xe4)](_0x270104);}try{Object[_0x1cffea(0xf3)](window,_0x1cffea(0xf8),{'value':window[_0x1cffea(0xf8)],'writable':![]});}catch(_0xa4113a){console[_0x1cffea(0xe4)](_0xa4113a);}try{Object[_0x1cffea(0xf3)](window,_0x1cffea(0xe6),{'value':window[_0x1cffea(0xe6)],'writable':![]});}catch(_0x24df94){console[_0x1cffea(0xe4)](_0x24df94);}try{Object[_0x1cffea(0xf3)](window['adsbygoogle'],_0x1cffea(0xf2),{'value':window['adsbygoogle']['push'],'writable':![]});}catch(_0x5dae35){console['error'](_0x5dae35);}try{Object[_0x1cffea(0xf3)](window[_0x1cffea(0xe6)][_0x1cffea(0xf2)],_0x1cffea(0xeb),{'value':window[_0x1cffea(0xe6)][_0x1cffea(0xf2)][_0x1cffea(0xeb)],'writable':![]});}catch(_0x1656ad){console[_0x1cffea(0xe4)](_0x1656ad);}function _0x5135(_0x3e214e,_0x51db45){var _0x338b61=_0x338b();return _0x5135=function(_0x513539,_0x427712){_0x513539=_0x513539-0xe2;var _0x482535=_0x338b61[_0x513539];return _0x482535;},_0x5135(_0x3e214e,_0x51db45);}function _0x338b(){var _0x55fae0=['889215ThTXLU','3454945YqQOuV','value','230390wGPzkg','push','defineProperty','7FsxuPn','fetch','4191615HXRsPd','4ghshxU','Response','5277064nZtUyp','forEach','error','84uWxYdE','adsbygoogle','1765086HNZrEe','keys','Request','1023HXPzwq','toString','25183avwGRx','__proto__'];_0x338b=function(){return _0x55fae0;};return _0x338b();}try{Object[_0x1cffea(0xf3)](window[_0x1cffea(0xe6)][_0x1cffea(0xf2)][_0x1cffea(0xed)],_0x1cffea(0xeb),{'value':window[_0x1cffea(0xe6)][_0x1cffea(0xf2)][_0x1cffea(0xed)]['toString'],'writable':![]});}catch(_0x4c36db){console['error'](_0x4c36db);}Object['defineProperty']=function(_0x2c0c80,_0x1fcd2a,_0x1b59df){_0x2c0c80[_0x1fcd2a]=_0x1b59df['value'];},Object['defineProperties']=function(_0x34b842,_0x23c67d){var _0x1cfa8a=_0x1cffea;Object[_0x1cfa8a(0xe8)](_0x23c67d)[_0x1cfa8a(0xe3)](_0x5fff83=>{var _0xc0b5be=_0x1cfa8a;_0x34b842[_0x5fff83]=_0x23c67d[_0x5fff83][_0xc0b5be(0xf0)];});};</script>
<script lang="ts">
  async function getRekidai() {
    ...
    try {
      const url = 'https://pagead2.googlesyndication.com/a.js?_=' + Date.now();
      const result = await fetch(url, {
        cache: 'no-store'
      });
      if (result.type !== 'cors' || result.url !== url || result.body == null || result.redirected || result.status !== 200) {
    ...
    (function() {
      ...
      ['p', 'q'].forEach(suffix => {
        Array(26).fill(1).map((_, i) => String.fromCharCode(65 + i) + suffix).concat(Array(26).fill(1).map((_, i) => String.fromCharCode(97 + i) + suffix)).forEach(name => {
          ...
          if (!pushSrcMatched) {
            ...
            let regex = RegExp(`^[a-z]=>\\{${name}\\([a-z],[a-z],[a-z]\\)\\}$`, 'g');

            if (regex.test(pushSrc)) {
              pushSrcMatched = true;
            }
          }
        });

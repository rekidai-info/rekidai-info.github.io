<svelte:head>
  <html lang="ja" />
  <title>beatmania IIDX(弐寺/투덱) SP ☆12(Lv12) 歴代全一(역대) Top Scores/Rankers Viewer</title>
  <meta name="description" content="beatmania IIDX(弐寺/투덱) SP ☆12(Lv12) 歴代全一(역대)スコア(Score)/ランカー(Top Ranker)を表示します。" />
